...
from SigProfilerSingleSamplePro import single_sample as ss
...
def mainstuff(r,layer_directory,verbose,denovo_exposureAvg,attribution,allsigids,background_sigs,processAvg,allgenomes,pcawg_rule,exposureAvg,initial_remove_penalty,add_penalty,remove_penalty,check_rule_negatives,check_rule_penalty,connected_sigs,solution_prefix):
        if verbose==True:
            print("\n\n\n\n\n                                        ################ Sample "+str(r+1)+ " #################")
        ...
        for de_novo_sig in init_sigs:
            init_decomposed_sigs = union(init_decomposed_sigs, attribution[de_novo_sig])
        ...
        if pcawg_rule==True:
            ...
            try:
                ...
                pass
        return layer_directory,verbose,denovo_exposureAvg,attribution,allsigids,background_sigs,processAvg,allgenomes,pcawg_rule,exposureAvg,initial_remove_penalty,add_penalty,remove_penalty,check_rule_negatives,check_rule_penalty,connected_sigs,solution_prefix, kldiv, correlation, cosine_similarity_with_four_signatures
...
def make_final_solution(processAvg, allgenomes, allsigids, layer_directory, m, index, allcolnames, process_std_error = "none", signature_stabilities = " ", \
    ...
    if cosmic_sigs==True:
        ...
        for r in range(allgenomes.shape[1]):
            ...
            layer_directory,verbose,denovo_exposureAvg,attribution,allsigids,background_sigs,processAvg,allgenomes,pcawg_rule,exposureAvg,initial_remove_penalty,add_penalty,remove_penalty,check_rule_negatives,check_rule_penalty,connected_sigs,solution_prefix,kldiv, correlation, cosine_similarity_with_four_signatures =  mainstuff(r,layer_directory,verbose,denovo_exposureAvg,attribution,allsigids,background_sigs,processAvg,allgenomes,pcawg_rule,exposureAvg,initial_remove_penalty,add_penalty,remove_penalty,check_rule_negatives,check_rule_penalty,connected_sigs,solution_prefix)
